...
LOOP:
	MOVLW	0XFE					;Seta o pino RB0 e reseta o pino RB1.
	MOVWF	PORTB					;      ..................
	CALL	DELAY					;Chama uma sub-rotina de atraso.
	MOVLW	0XFD					;Seta o pino RB1 e reseta o pino RB0.
	MOVWF	PORTB
	CALL	DELAY
